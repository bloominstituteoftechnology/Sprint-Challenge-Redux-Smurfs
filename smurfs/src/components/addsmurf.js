    ...
    return(
      <div className="form">
        ...
        <Form>
          ...
          <Button color="primary" onClick={() => this.props.submitButton('http://localhost:3333/smurfs/', {name: this.state.name, age: this.state.age, height: this.state.height}, this.props.smurfID )}>Submit</Button>
        </Form>
      </div>
    );
  }
