        ...
        return (
            <div key={this.props.id}>
                ...
                {this.state.show ?
                    ...
                    /> :
                    <button onClick={this.toggleShow} className="button button-update" >Update Smurf</button>}
                <button className="button button-delete" onClick={() => this.props.deleteSmurf(this.props.id)} >X</button>
            </div>
        )
    }
}
