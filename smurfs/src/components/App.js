...
import { loadSmurfsAction, addSmurfAction, updateSmurfAction, deleteSmurfAction } from '../actions'
...
export default connect(mapStateToProps, { loadSmurfsAction, addSmurfAction, updateSmurfAction, deleteSmurfAction })(App);
