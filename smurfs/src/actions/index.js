  ...
  axios
    ...
    .catch((error) => {
      dispatch({
        ...
        errorMessage: 'Error fetching smurfs'
      })
    })
}
...
export const deleteSmurf = (id) => (dispatch) => {
  ...
  axios
    ...
    .catch((err) => {
      dispatch({
        type: ERROR_DELETING_SMURF,
        errorMessage: 'Error deleting smurf'
      })
    })
}
...
export const updateSmurf = (id) => (dispatch) => {
  ...
  axios
    ...
    .then((res) => {
      dispatch({ type: SMURF_UPDATED, smurfs: res.data })
    })
    .catch((err) => {
      dispatch({
        type: ERROR_UPDATING_SMURF,
        errorMesage: 'Error updating smurf'
      })
    })
}
